...
_wordFrequencyDictPath("../WordFreq_Idx_Dir/wordFreq.dat"),
_wordIdxTablePath("../WordFreq_Idx_Dir/wordIdx.dat"),
_isEn(false)
{
}
            ...
            for(string word : words){
                ...
                if(!_isEn){//中文
                    ...
                    while(letterIndex < word.size()){
                        ...
                        _WordIdxTable[word.substr(letterIndex,len)].insert(wordIndex);
                        letterIndex += len;
                    }
                }
                else{//英文
                    ...
                    while(letterIndex < word.size()){
                        ...
                        _WordIdxTable[word.substr(letterIndex,n)].insert(wordIndex);
...
void DictProducer::storeIndex(){
    ...
    ofstream ofs;
    ofs.open(_wordIdxTablePath,ios::app|ios::out);
    if(!ofs.good()){
        cout << "ofstream open error" << endl;
        return;
    }
    for(auto it : _WordIdxTable){
        ofs << it.first <<" ";
